...
const HomeScreen = ({ navigation }) => {
  ...
  const openChat = (item) => {
    ...
    if (!conversationWith) {
      console.error(
        "Conversation data is missing the conversationWith property",
        item
      );
  ...
  const handleGroupPress = (item) => {
    ...
    if (conversations && conversations.length > 0) {
      ...
      const matchingConversation =
        conversations.find(
          (conv) =>
            conv.conversationWith && conv.conversationWith.name === item.name
        ) || conversations[0];
      ...
      <View style={styles.tabBar}>
        ...
        >
          <View
            style={[
              styles.tabIcon,
              activeTab === "calendar" ? styles.activeTabIcon : {},
            ]}
          >
        ...
        >
          <View
            style={[
              styles.tabIcon,
              activeTab === "chats" ? styles.activeTabIcon : {},
            ]}
          >
            <Text style={styles.tabIconText}>💬</Text>
          </View>
        ...
        >
          <View
            style={[
              styles.tabIcon,
              styles.homeTabIcon,
              activeTab === "home" ? styles.activeHomeTabIcon : {},
            ]}
          >
            <Text style={styles.tabIconText}>🏠</Text>
          </View>
        ...
        >
          <View
            style={[
              styles.tabIcon,
              activeTab === "games" ? styles.activeTabIcon : {},
            ]}
          >
            <Text style={styles.tabIconText}>🎮</Text>
          </View>
        ...
        >
          <View
            style={[
              styles.tabIcon,
              activeTab === "career" ? styles.activeTabIcon : {},
            ]}
          >
            <Text style={styles.tabIconText}>💼</Text>
          </View>
